...
export default function ConsultationPage({ params }: { params: { visitId: string } }) {
    ...
    // R49: insurance feature flag. When OFF, the "Pre-Authorizations"
        ...
        <div className={styles.container}>
            ...
            <div className={styles.layout}>
                ...
                <aside className={styles.sidebar}>
                    ...
                    {insuranceEnabled && patientInsurance && (
                        <div className={styles.sidebarCard} style={{ borderLeft: "3px solid #6366f1" }}>
                            <h2 className={styles.sidebarTitle}>
                                <Shield size={18} style={{ marginRight: "8px", verticalAlign: "middle", color: "#6366f1" }} />
                                Pre-Authorizations
                            </h2>
                            ...
                            <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem", marginBottom: "1.5rem" }}>
                                ...
                                <button
                                    ...
                                    onClick={async () => {
                                        ...
                                        const res = await fetch("/api/admin/insurance/authorizations", {
                                            method: "POST",
                                            credentials: "include",
                                            headers: { "Content-Type": "application/json" },
                                            body: JSON.stringify({
